...
library LibMToken {
    ...
    modifier initializer(LayoutTypes.DelegationMTokenLayout storage s) {
    ...
    function layout()
        internal
        pure
        returns (LayoutTypes.DelegationMTokenLayout storage s)
    {
     ...
     **/
    function initialize(
        LayoutTypes.DelegationMTokenLayout storage s,
        string memory name,
    ...
    function RESERVE_TREASURY_ADDRESS(LayoutTypes.DelegationMTokenLayout storage s)
        internal
        view
        returns (address)
    {
    ...
    function UNDERLYING_ASSET_ADDRESS(LayoutTypes.DelegationMTokenLayout storage s)
        internal
        view
        returns (address)
    {
    ...
    function DOMAIN_SEPARATOR(LayoutTypes.DelegationMTokenLayout storage s) internal view returns (bytes32) {
    ...
    function nonces(LayoutTypes.DelegationMTokenLayout storage s, address owner) internal view returns (uint256) {
        return s._nonces[owner];
    }

    function name(LayoutTypes.DelegationMTokenLayout storage s) internal view returns (string memory) {
        return s._name;
    }

    function symbol(LayoutTypes.DelegationMTokenLayout storage s) internal view returns (string memory) {
        return s._symbol;
    }

    function decimals(LayoutTypes.DelegationMTokenLayout storage s) internal view returns (uint8) {
        return s._decimals;
    }

    function balanceOf(LayoutTypes.DelegationMTokenLayout storage s, address user) internal view returns (uint256) {
        return s._userState[user].balance.rayMul(IPool(s._pool).getReserveNormalizedIncome(s._underlyingAsset));
    }

    function totalSupply(LayoutTypes.DelegationMTokenLayout storage s) internal view returns (uint256) {
    ...
    function allowance(LayoutTypes.DelegationMTokenLayout storage s, address owner, address spender) internal view returns (uint256) {
        return s._allowances[owner][spender];
    }

    function increaseAllowance(LayoutTypes.DelegationMTokenLayout storage s, address spender, uint256 addedValue) internal returns (bool) {
        _approve(s, Query._msgSender(), spender, s._allowances[Query._msgSender()][spender] + addedValue);
        return true;
    }

    function decreaseAllowance(LayoutTypes.DelegationMTokenLayout storage s, address spender, uint256 subtractedValue) internal returns (bool) {
       _approve(s, Query._msgSender(), spender, s._allowances[Query._msgSender()][spender] + subtractedValue);
        return true;
    }

    function approve(LayoutTypes.DelegationMTokenLayout storage s, address spender, uint256 amount) internal returns (bool) {
        _approve(s, Query._msgSender(), spender, amount);
        return true;
    }

    function scaledBalanceOf(LayoutTypes.DelegationMTokenLayout storage s, address user) internal view returns (uint256) {
        return s._userState[user].balance;
    }

    function scaledTotalSupply(LayoutTypes.DelegationMTokenLayout storage s) internal view returns (uint256) {
        return s._totalSupply;
    }

    function getScaledUserBalanceAndSupply(LayoutTypes.DelegationMTokenLayout storage s, address user) internal view returns (uint256, uint256) {
        return (s._userState[user].balance, s._totalSupply);
    }

    function getPreviousIndex(LayoutTypes.DelegationMTokenLayout storage s, address user) internal view returns (uint256) {
        return s._userState[user].additionalData;
    }

    function transfer(LayoutTypes.DelegationMTokenLayout storage s, address recipient, uint256 amount) internal returns (bool) {
    ...
    function transferUnderlyingTo(LayoutTypes.DelegationMTokenLayout storage s, address target, uint256 amount) internal {
     ...
     */
    function _mint(LayoutTypes.DelegationMTokenLayout storage s, address account, uint128 amount) internal {
     ...
     */
    function _burn(LayoutTypes.DelegationMTokenLayout storage s, address account, uint128 amount) internal {
        uint256 oldTotalSupply = s._totalSupply;
        s._totalSupply = oldTotalSupply - amount;
