...
library SupplyLogic {
  ...
  /**
   * @notice Implements the supply feature. Through `supply()`, users supply assets to the Maria protocol.
  ...
  function executeSupply(
    ...
    if (isFirstSupply) {
      /* 
        Enables asset to be used as collateral if
        no asset is being used as collateral,
        asset is not in isolation mode 
   ...
   * previously supplied in the Maria protocol.
  ...
  function executeWithdraw(
    ...
    // Disables asset to be used as collateral if user withdraws all balance
  ...
  function executeUseReserveAsCollateral(
    ...
    // Enables or Disables asset as collateral
    if (useAsCollateral) {
      require(
        ValidationLogic.validateUseAsCollateral(
          reservesData,
